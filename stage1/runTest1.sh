...
if [ $? -eq 1 ] ; then
    ...
    if [ $# -eq 0 ] ; then
        ...
        for i in $count ; do
            cleaned=${i:0:3}
            ./stage1 testing/dat/$cleaned.dat testing/output/lst/$cleaned.lst testing/output/asm/$cleaned.asm
        ...
        for i in $@ ; do
            echo $i
            ./stage1 testing/dat/$i.dat testing/output/lst/$i.lst testing/output/asm/$i.asm
